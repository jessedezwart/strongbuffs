...
export function createDefinitionFromManifest(meta: ActionMeta | { defaults: DefinitionNode; fields: ManifestField[] }): DefinitionNode
{
...
export function createExportedRule(rule: RuleState, manifest: Manifest): RuleState
{
	return {
		schemaVersion: manifest.schemaVersion,
		name: rule.name.trim(),
